...
. Apply fine‑grained access control by issuing time‑bound credentials through Polaris; table‑level policies are enforced directly by *Ceph Object Gateway (RGW)*, no proxy, no performance penalty.
 ...
 ** And with the least priveledges required
