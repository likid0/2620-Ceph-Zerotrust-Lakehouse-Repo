...
like this one image::update_chart.png[refresh,800]
====
...
[sidebar.ceph-spotlight]
****
**IBM Storage Ceph: the foundation layer**
What made this end-to-end scenario possible was Ceph’s combination of scale-out durability and AWS-compatible object/IAM/STS interfaces. We drove everything—tenancy, scoped credentials, bucket policy, Terraform automation, multi-engine reads—through that API surface. No data copies, no custom gateways, just open protocols and open source software you can run anywhere.
****
