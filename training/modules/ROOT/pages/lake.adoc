...
=== Three Forces Pulling You Apart
...
=== Common “Fixes” That Don’t Really Fix Anything
...
In the *Database* drop‑down, choose **Trino (Iceberg)**. +
  _Schema_ may auto‑fill to `prod_ns`; if not, pick it manually.
...
image::step‑01.png[Query results,600]
...
image::step‑02.png[Save dataset dialog,500]
...
image::step‑03.png[Populated Data tab,600]
...
image::step‑04.png[Dashboard with new chart,700]
